...
export default function ReceitasPage() {
  ...
  const totalReceitas = FinancialCalculations.calculateTotal(filteredRecords);
  const categoryTotals = INCOME_CATEGORIES.map(category => ({
    name: category,
          ...
          <div className="flex justify-between items-center h-16">
            <div>
              ...
              <p className="text-sm text-gray-600">
                {FinancialStorage.formatMonth(selectedMonth)} • Total: {FinancialCalculations.formatCurrency(totalReceitas)}
              </p>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    <DialogTitle>
                      {editingRecord ? 'Editar Receita' : 'Nova Receita'}
                    </DialogTitle>
                  </DialogHeader>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        placeholder="Ex: Salário mensal - Empresa XYZ"
                        required
                      />
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {FinancialCalculations.formatCurrency(totalReceitas)}
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium">R$ 10.000,00</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-gray-600">Progresso</span>
                    <Badge variant={totalReceitas >= 10000 ? "default" : "secondary"}>
                      {((totalReceitas / 10000) * 100).toFixed(1)}%
                    </Badge>
                  </div>
                </div>
              </CardContent>
